...
## Contents
- `lab01/`, `lab02/`, `lab03/`, `lab04/`, … — one folder per lab
- `src/` — main source file(s)
- `build/` — compiled binaries (can be git-ignored)
...
## Lab 4 (Example)
Topic: series evaluation and comparison with a standard library function; prints two simple tables with results and accuracy. Input is via console; output is plain text.

## Notes
- All labs are minimal, console-based, and beginner-friendly.
- Code is organized per lab so graders can compile and run quickly.
